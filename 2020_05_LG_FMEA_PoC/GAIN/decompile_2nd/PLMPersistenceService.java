...
import com.dassault_systemes.sfy.persistence.PLMPersistenceService$1;
import com.dassault_systemes.sfy.persistence.PLMPersistenceService$2;
import com.dassault_systemes.sfy.persistence.PLMPersistenceService$CompositeId;
import com.dassault_systemes.sfy.persistence.PLMPersistenceService$SemanticRelation;
import com.dassault_systemes.sfy.persistence.PLMPersistenceService$TPath;
...
public class PLMPersistenceService {
	...
	protected Map<String, PLMPersistenceService$TPath> pathsById = new HashMap();
	...
	protected void updateInsideRep(Context var1, String var2, String var3, String var4, String var5, String var6,
		...
		PLMPersistenceService$CompositeId var9 = new PLMPersistenceService$CompositeId(this, var2);
	...
	protected void updatePathElements(Context var1, String var2, String var3, String var4, String var5, String var6,
			Map<String, Object> var7, Map<String, String> var8) throws Exception {
		PLMPersistenceService$TPath var9 = (PLMPersistenceService$TPath) this.pathsById.get(var2);
		if (var9 != null) {
	...
	protected void updatePaths(Context var1, String var2, String var3, String var4, String var5, String var6,
		...
		while (var13.hasNext()) {
			...
			PLMPersistenceService$TPath var15 = (PLMPersistenceService$TPath) this.pathsById.get(var14);
			if (var15 != null) {
	...
	protected void updatePort(Context var1, String var2, String var3, String var4, String var5, String var6,
		...
		PLMPersistenceService$TPath var22 = (PLMPersistenceService$TPath) this.pathsById.get(var6);
		AttributeList var24 = new AttributeList();
		PLMPersistenceService$SemanticRelation[] var16 = PLMPersistenceService$SemanticRelation.values();
		PLMPersistenceService$SemanticRelation var17 = null;
		PLMPersistenceService$SemanticRelation[] var18 = var16;
		int var19 = var16.length;

		for (int var20 = 0; var20 < var19; ++var20) {
			PLMPersistenceService$SemanticRelation var21 = var18[var20];
		...
		if (var22 == null) {
			...
			var22 = new PLMPersistenceService$TPath(this, var25, var4, "Reference3", var24);
	...
	protected void createPath(Context var1, String var2, String var3, Map<String, String> var4,
		...
		PLMPersistenceService$SemanticRelation var10 = PLMPersistenceService$SemanticRelation.valueOf(var7);
		...
		PLMPersistenceService$TPath var14 = new PLMPersistenceService$TPath(this, var2, var12, var13, var6);
	...
	protected static String addPathToBusinessObject(Context var0, PLMPersistenceService$TPath var1, String var2, Map<String, Object> var3,
	...
	public void postUpdate(Context var1, List<Throwable> var2, List<Throwable> var3, Map<String, Object> var4,
		...
		while (var7.hasNext()) {
			...
			PLMPersistenceService$CompositeId var9 = new PLMPersistenceService$CompositeId(this, var8);
	...
	protected Map<String, String> enrichJSONIds(Set<String> var1, String var2, String var3) {
		...
		while (var5.hasNext()) {
			...
			PLMPersistenceService$CompositeId var9 = new PLMPersistenceService$CompositeId(this, var2, var8, var6);
	...
	public void preprocessUpdates(List<UpdateStatement> var1) {
      var1.sort(new PLMPersistenceService$1(this));
   }

	public void preprocessCreates(List<CreateStatement> var1) {
      var1.sort(new PLMPersistenceService$2(this));
   }
